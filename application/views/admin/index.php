<div class="content-body">
    ...
    <div class="container-fluid">
        <div class="form-head d-flex align-items-center mb-sm-4 mb-3">
            ...
            <a href="javascript:void(0)" class="btn btn-outline-primary"><i class="las la-cog scale5 mr-3"></i>Sesuaikan Tata Letak</a>
        </div>
        <div class="row">
            <div class="col-xl-3 col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body mr-3">
                                <h2 class="fs-34 text-black font-w600"><?= $jml_konsul; ?></h2>
                    ...
                    <div class="progress  rounded-0" style="height:4px;">
                        <div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: <?= $jml_konsul / 20 * 100 ?>%; height:4px;" role="progressbar">
            ...
            <div class="col-xl-3  col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body mr-3">
                                <h2 class="fs-34 text-black font-w600"><?= $jml_pasien; ?></h2>
            ...
            <div class="col-xl-3  col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body mr-3">
                                <h2 class="fs-34 text-black font-w600"><?= $jml_dokter; ?></h2>
            ...
            <div class="col-xl-3  col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body mr-3">
                                <h2 class="fs-34 text-black font-w600">Rp3.000,-</h2>
                                <span>Pendapatan Rumah Sakit</span>
                            </div>
                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card">
                            <div class="card-header d-sm-flex d-block pb-0 border-0">
                                <div class="mr-auto pr-3">
                                    <h4 class="text-black fs-20 mb-0">Persentasi Pasien</h4>
                                </div>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center px-4 bg-light">
                                            <div class="mr-auto d-flex align-items-center py-3">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fs-26 text-primary font-w600"><?= $jml_pasien; ?></span>
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card rated-doctors">
                            <div class="card-header border-0 pb-0">
                                <h3 class="fs-20 text-black mb-0 mr-auto">Dokter Peringkat Teratas</h3>
                                <a href="javascript:void(0)" class="btn-link">Lebih Banyak >></a>
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card appointment-schedule">
                            <div class="card-header pb-0 border-0">
                                <h3 class="fs-20 text-black mb-0">Jadwal Janji Temu</h3>
                    ...
                    <div class="col-xl-12">
                        <div class="card patient-activity">
                            <div class="card-header border-0 pb-0">
                                <h3 class="fs-20 text-black mb-0">Aktivitas Pasien Terbaru</h3>
                                <div class="dropdown ml-auto">

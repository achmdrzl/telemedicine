        ...
        <section class="slider">
            <div class="slick-carousel m-slides-0" data-slick='{"slidesToShow": 1, "arrows": true, "dots": false, "speed": 700,"fade": true,"cssEase": "linear"}'>
                <div class="slide-item align-v-h">
                    <div class="bg-img"><img src="<?php echo base_url()?>assets2/images/sliders/1.jpg" alt="slide img"></div>
                    <div class="container">
                ...
                <div class="slide-item align-v-h">
                    <div class="bg-img"><img src="<?php echo base_url()?>assets2/images/sliders/2.jpg" alt="slide img"></div>
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                                <div class="slide__content">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-5">
                        ...
                        <div class="video-banner-layout2 bg-overlay">
                            <img src="<?php echo base_url()?>assets2/images/about/2.jpg" alt="about" class="w-100">
    ...
    =========================== -->
        <section class="services-layout1 services-carousel">
            <div class="bg-img"><img src="<?php echo base_url()?>assets2/images/backgrounds/2.jpg" alt="background"></div>
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/1.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/2.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                            <div class="feature__content">
                                <div class="feature__icon">
                                    <i class="icon-doctor"></i>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/3.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                            <div class="feature__content">
                                <div class="feature__icon">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/4.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                            <div class="feature__content">
                                <div class="feature__icon">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/5.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                            <div class="feature__content">
                                <div class="feature__icon">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/6.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                            <div class="feature__content">
                                <div class="feature__icon">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/7.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                            <div class="feature__content">
                                <div class="feature__icon">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="feature-item">
                            <div class="feature__img">
                                <img src="<?php echo base_url()?>assets2/images/services/8.jpg" alt="service" loading="lazy">
                            </div><!-- /.feature__img -->
                            <div class="feature__content">
                                <div class="feature__icon">
                        ...
                        <div class="slick-carousel" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "autoplay": true, "arrows": false, "dots": false, "responsive": [ {"breakpoint": 992, "settings": {"slidesToShow": 2}}, {"breakpoint": 767, "settings": {"slidesToShow": 1}}, {"breakpoint": 480, "settings": {"slidesToShow": 1}}]}'>
                            ...
                            <div class="member">
                                <div class="member__img">
                                    <img src="<?php echo base_url()?>assets2/images/team/1.jpg" alt="member img">
                                </div><!-- /.member-img -->
                            ...
                            <div class="member">
                                <div class="member__img">
                                    <img src="<?php echo base_url()?>assets2/images/team/2.jpg" alt="member img">
                                </div><!-- /.member-img -->
                                <div class="member__info">
                            ...
                            <div class="member">
                                <div class="member__img">
                                    <img src="<?php echo base_url()?>assets2/images/team/3.jpg" alt="member img">
                                </div><!-- /.member-img -->
                                <div class="member__info">
                            ...
                            <div class="member">
                                <div class="member__img">
                                    <img src="<?php echo base_url()?>assets2/images/team/4.jpg" alt="member img">
                                </div><!-- /.member-img -->
                                <div class="member__info">
                            ...
                            <div class="member">
                                <div class="member__img">
                                    <img src="<?php echo base_url()?>assets2/images/team/5.jpg" alt="member img">
                                </div><!-- /.member-img -->
                                <div class="member__info">
                            ...
                            <div class="member">
                                <div class="member__img">
                                    <img src="<?php echo base_url()?>assets2/images/team/6.jpg" alt="member img">
                                </div><!-- /.member-img -->
                                <div class="member__info">
    ...
    ========================= -->
        <section class="work-process work-process-carousel pt-130 pb-0 bg-overlay bg-overlay-secondary">
            <div class="bg-img"><img src="<?php echo base_url()?>assets2/images/banners/1.jpg" alt="background"></div>
            <div class="container">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-sm-12 col-md-2 col-lg-2">
                            <img src="<?php echo base_url()?>assets2/images/icons/alert2.png" alt="alert">
                        </div><!-- /.col-lg-2 -->
                            ...
                            <div class="slider-nav mb-60">
                                <div class="testimonial__meta">
                                    <div class="testimonial__thmb">
                                        <img src="<?php echo base_url()?>assets2/images/testimonials/thumbs/1.png" alt="author thumb">
                                ...
                                <div class="testimonial__meta">
                                    <div class="testimonial__thmb">
                                        <img src="<?php echo base_url()?>assets2/images/testimonials/thumbs/2.png" alt="author thumb">
                                    </div><!-- /.testimonial-thumb -->
                                    <div>
                                ...
                                <div class="testimonial__meta">
                                    <div class="testimonial__thmb">
                                        <img src="<?php echo base_url()?>assets2/images/testimonials/thumbs/3.png" alt="author thumb">
                                    </div><!-- /.testimonial-thumb -->
                                    <div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="slick-carousel" data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "autoplay": true, "arrows": true, "dots": false, "responsive": [ {"breakpoint": 992, "settings": {"slidesToShow": 2}}, {"breakpoint": 767, "settings": {"slidesToShow": 2}}, {"breakpoint": 480, "settings": {"slidesToShow": 1}}]}'>
                            <a class="popup-gallery-item" href="<?php echo base_url()?>assets2/images/gallery/1.jpg">
                                <img src="<?php echo base_url()?>assets2/images/gallery/1.jpg" alt="gallery img">
                            </a>
                            <a class="popup-gallery-item" href="<?php echo base_url()?>assets2/images/gallery/2.jpg">
                                <img src="<?php echo base_url()?>assets2/images/gallery/2.jpg" alt="gallery img">
                            </a>
                            <a class="popup-gallery-item" href="<?php echo base_url()?>assets2/images/gallery/3.jpg">
                                <img src="<?php echo base_url()?>assets2/images/gallery/3.jpg" alt="gallery img">
                            </a>
                            <a class="popup-gallery-item" href="<?php echo base_url()?>assets2/images/gallery/4.jpg">
                                <img src="<?php echo base_url()?>assets2/images/gallery/4.jpg" alt="gallery img">
                            </a>
                            <a class="popup-gallery-item" href="<?php echo base_url()?>assets2/images/gallery/5.jpg">
                                <img src="<?php echo base_url()?>assets2/images/gallery/5.jpg" alt="gallery img">
                            </a>
                            <a class="popup-gallery-item" href="<?php echo base_url()?>assets2/images/gallery/6.jpg">
                                <img src="<?php echo base_url()?>assets2/images/gallery/6.jpg" alt="gallery img">
                            </a>
    ...
    =========================== -->
        <section class="contact-layout3 bg-overlay bg-overlay-primary-gradient pb-60">
            <div class="bg-img"><img src="<?php echo base_url()?>assets2/images/banners/3.jpg" alt="banner"></div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-7">
                        <div class="contact-panel mb-50">
                            <form class="contact-panel__form" method="post" action="<?php echo base_url()?>assets2/php/contact.php" id="contactForm">
                                <div class="row">
                                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-5">
                        ...
                        <div class="slick-carousel clients-light mt-20" data-slick='{"slidesToShow": 3, "arrows": false, "dots": false, "autoplay": true,"autoplaySpeed": 2000, "infinite": true, "responsive": [ {"breakpoint": 992, "settings": {"slidesToShow": 3}}, {"breakpoint": 767, "settings": {"slidesToShow": 2}}, {"breakpoint": 480, "settings": {"slidesToShow": 2}}]}'>
                            <div class="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/1.png" alt="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/1.png" alt="client">
                            </div><!-- /.client -->
                            <div class="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/2.png" alt="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/2.png" alt="client">
                            </div><!-- /.client -->
                            <div class="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/3.png" alt="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/3.png" alt="client">
                            </div><!-- /.client -->
                            <div class="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/4.png" alt="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/4.png" alt="client">
                            </div><!-- /.client -->
                            <div class="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/5.png" alt="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/5.png" alt="client">
                            </div><!-- /.client -->
                            <div class="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/6.png" alt="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/6.png" alt="client">
                            </div><!-- /.client -->
                            <div class="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/7.png" alt="client">
                                <img src="<?php echo base_url()?>assets2/images/clients/7.png" alt="client">
                            </div><!-- /.client -->
                        </div><!-- /.carousel -->
                    </div><!-- /.col-lg-5 -->
                ...
                <div class="row">
                        ...
                        <div class="post-item">
                            <div class="post__img">
                                <a href="blog-single-post.html">
                                    <img src="<?php echo base_url()?>assets2/images/blog/grid/1.jpg" alt="post image" loading="lazy">
                                </a>
                            </div><!-- /.post__img -->
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item">
                            <div class="post__img">
                                <a href="blog-single-post.html">
                                    <img src="<?php echo base_url()?>assets2/images/blog/grid/2.jpg" alt="post image" loading="lazy">
                                </a>
                            </div><!-- /.post__img -->
                            <div class="post__body">
                                <div class="post__meta-cat">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="post-item">
                            <div class="post__img">
                                <a href="blog-single-post.html">
                                    <img src="<?php echo base_url()?>assets2/images/blog/grid/3.jpg" alt="post image" loading="lazy">
                                </a>
                            </div><!-- /.post__img -->
                            <div class="post__body">
                                <div class="post__meta-cat">
